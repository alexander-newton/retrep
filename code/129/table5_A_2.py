...
#==============================================================================
# REGRESSION - Table 5 Panel A Column 2 (control)
# Based on Stata script:
# areg ln_u1800 ind_law ln_db_total1470 ln_db_total1420
#	ind_inco_pre1517 ind_mkts_pre1517 books_0-books_1001
#	ind_freecity ind_univ_by1517 students10*
#	pop1500* mean_plague1349_1499
...
# Outcome variable: ln_u1800 (log of 1800 upper tail human capital)
...
# Define X matrix for Column 2: control specification
...
X_vars = ['ind_law', 'ln_db_total1470', 'ln_db_total1420',
          ...
          'mean_plague1349_1499'] + books_cols + students_cols + pop_cols + ['polity1500_code']
...
metadata = {
    ...
    'comments': 'Table 5 Panel A Column 2: OLS regression of log 1800 upper tail on reformation laws with controls, polity1500 FE, clustered SE'
}
