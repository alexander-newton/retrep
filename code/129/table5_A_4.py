...
#==============================================================================
# REGRESSION - Table 5 Panel A Column 4 (cantoni)
# Based on Stata script:
# areg ln_u1800 ln_db_total1470 ln_db_total1420
...
# Define X matrix for Column 4: Cantoni specification (NOTE: no ind_law in cantoni spec)
...
metadata = {
    ...
    'comments': 'Table 5 Panel A Column 4: Cantoni specification - OLS regression of log 1800 upper tail on Cantoni variables, polity1500 FE, clustered SE'
}
