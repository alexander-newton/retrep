...
#==============================================================================
# REGRESSION - Table 6 Panel B Column 1 (IV: Upper Tail Human Capital 1750)
# Based on Stata script:
# ivreg2 ln_db_total1750 ln_db_total1420 ln_db_total1470
...
exog_vars = ['ln_db_total1420', 'ln_db_total1470',
             'mean_plague1349_1499',
             'ind_inco_pre1517', 'ind_mkts_pre1517', 'ind_freecity',
...
metadata = {
    'paper_id': '129',
    'table_id': '6',
    'panel_identifier': 'B_1_humancapital',
    'model_type': 'log-linear',
    'comments': 'Table 6 Panel B Column 1: IV regression of log 1750 upper tail human capital on law (instrumented by plagues 1500-1522), no territory FE, clustered SE'
}
