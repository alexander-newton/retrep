...
* Define environment
********************************************************************************
* Hardcode paths directly - no YAML needed
* Hardcode paths directly - no YAML needed
global data "/Users/kimik/Library/CloudStorage/GoogleDrive-kimiaazargarzadeh@gmail.com/My Drive/retrep/rawdata/006"
global confidential_main "/Users/kimik/Library/CloudStorage/GoogleDrive-kimiaazargarzadeh@gmail.com/My Drive/retrep/rawdata/006"
global confidential_L2 "/Users/kimik/Library/CloudStorage/GoogleDrive-kimiaazargarzadeh@gmail.com/My Drive/retrep/rawdata/006"
global intermediatedata "/Users/kimik/Library/CloudStorage/GoogleDrive-kimiaazargarzadeh@gmail.com/My Drive/retrep/intermediatedata"
global output "/Users/kimik/Library/CloudStorage/GoogleDrive-kimiaazargarzadeh@gmail.com/My Drive/retrep/outputdata"

* Hardcode the experiment dates
global start_experiment = 21450  // September 24, 2018
global midline = 21464           // October 8, 2018  
global endline = 21492           // November 5, 2018
*****************************************************
...
* Create imputation indicator variables
foreach v in happy lonely pos_emotion {
    gen `v'_sms_summary_b_imp = 0
    gen `v'_sms_summary_imp = 0
}

* Create other imputation indicators
gen mobile_minutes_wins_b_imp = 0
gen mobile_minutes_wins_imp = 0

forvalues x=4/7 {
    gen swb_eurhappsvy_`x'_b_imp = 0
    gen swb_eurhappsvy_`x'_imp = 0
}
...
save "$intermediatedata/006/final_data.dta", replace
