...
# =====================================
# Table 2 Panel A Column 3: areg with plu_* maj controls
# Dependent variable: logdelay (log of delay)
...
required_vars = ['logdelay', 'pm_party_b', 'countrynumber'] + control_vars
df_sample = df_sample.dropna(subset=required_vars)

# Dependent variable
y = np.exp(df_sample['logdelay'].values)
...
metadata = {
    ...
    'comments': 'Table 2 Panel A Column 3: areg logdelay on pm_party_b with plu_* and maj controls, country FE, winner==1 sample'
}
