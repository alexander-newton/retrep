...
# =====================================
# Table 2 Panel A Column 4: areg with plu_* maj controls and family FE
...
required_vars = ['logdelay', 'pm_party_b', 'countrynumber', 'family'] + control_vars
...
metadata = {
    ...
    'comments': 'Table 2 Panel A Column 4: areg logdelay on pm_party_b with plu_* and maj controls, country and family FE, winner==1 sample'
}
