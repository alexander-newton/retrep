...
# Table 10 Panel A Column 6: Specification 3 for dev_spending1912
# This corresponds to specification3 = det_Fasci + det_Mafia + basics
dep_var = 'dev_spending1912'
endog_var = 'Mafia1900'
...
# Clean data - filter as in Stata: if dev_spending1912!=. and sp3m1893_n30!=.
...
metadata = {
    ...
    'comments': 'Table 10 Panel A Column 6: IV regression of development expenditure 1912 on Mafia1900 instrumented by spring rainfall 1893, specification 3 (all controls)'
}
