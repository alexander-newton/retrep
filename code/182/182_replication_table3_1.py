...
# =====================================
# Paper 182 - "Intergenerational Mobility in Florence" (REStud)
...
# Drop missing
reg_df = df[['wage_2011', 'lwage', 'lwage_1427_noc', 'freq']].dropna().reset_index(drop=True)
...
# Save to parquet
out_dir = os.path.join(output_folder, '182', 'Table3_Col1')
