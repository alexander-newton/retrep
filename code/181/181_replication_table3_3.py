...
# =====================================
# Paper 181 - Table 3, Column 3
# Same as Col 1 but at SITC 4-digit level
# =====================================

base_path = '/Users/ellenmunroe/Downloads/112606-V1/MS_AER-2010-0514-R3_Replication_Files'

# Step 1: World export shares at sitc4 level
...
wexp['sitc_ind'] = wexp['sitc4'].str[:4]
...
out_dir = os.path.join(output_folder, '181', 'Table3_Col3')
