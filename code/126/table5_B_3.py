...
metadata = {
    ...
    'comments': 'Table 5 Panel B Column 3: 2SLS regression of l_value_added_manuf_est on recentEU_predpop with city + stateyear FE, clustered SE at MSA level'
}
