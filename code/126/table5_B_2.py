...
metadata = {
    ...
    'comments': 'Table 5 Panel B Column 2: 2SLS regression of l_occscore on recentEU_predpop with city + stateyear FE, clustered SE at MSA level'
}
