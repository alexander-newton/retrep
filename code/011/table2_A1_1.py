...
INPUT_DATA_DIR = config['intermediatedata'] # Could be intermediate data as well
...
metadata_result_1 = {
    'paper_id': '011', #Put only the 3 digit code, here more because example.
    'table_id': '2',
    'panel_identifier': 'A1_1', # THIS WILL NEED TO CHANGE FOR EACH RESULT
