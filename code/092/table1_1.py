...
# =========================
# COLUMN 1: VAT INCREASES ONLY
# =========================
# Filter for increases (event_incr != 0 means exclude non-increases)
df_increases = df[df['event_incr'] != 0].copy()
...
df_clean = df_increases[vars_needed].dropna()
